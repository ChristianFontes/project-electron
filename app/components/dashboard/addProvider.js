...
export default class InputField extends Component {
  ...
  constructor(props) {
   ...
   if (this.props.create) {
     showButton = 'create';
     titleAppBar = 'Crear un nuevo Proveedor'
   }
  ...
  buttonAction = () => {
    if (this.state.showButton == 'create') {
      ...
      return(
        <div style={style}>
          <RaisedButton label="Crear nuevo Proveedor" primary={true} onClick={::this.handleCreate}/>
        </div>
      )
    }
    return null;
  ...
  showTicketCreated = () => {
    ...
    if (this.state.ticketCreated !== undefined || this.state.ticketCreated !== null ) {
      ...
      return (
        <h3 style={style}>Proveedor creado con exito</h3>
      )
    }
    return null;
  }
    ...
    return (
      <div style={styleForm}>
        ...
        <Card>
          ...
          <TextField
            hintText="Nombre de la Proveedor"
